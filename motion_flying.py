...
lighthouse_deck_attached_event = Event()
...
def param_deck_flow(_, value_str):
    ...
    if value:
        ...
        print('Optical Flow Deck is attached!')
    else:
        print('Optical Flow Deck is NOT attached!')

def param_deck_lighthouse(_, value_str):
    value = int(value_str)
    print(value)
    if value:
        lighthouse_deck_attached_event.set()
        print('Lighthouse Deck is attached!')
    else:
        print('Lighthouse Deck NOT attached!')
...
if __name__ == '__main__':
    ...
    with SyncCrazyflie(URI, cf=Crazyflie(rw_cache='./cache')) as scf:
        ...
        #if not lighthouse_deck_attached_event.wait(timeout=5):
