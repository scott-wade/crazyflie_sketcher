...
filename = "acsi_text_2.csv"

def normalize_pts(x_points, y_points, z_points, max_x = .55, max_y = .25):
...
create_ref(x_avg, y_avg, z_avg, vx, vy, vz, "text_FD.csv")
...
create_ref(x_avg, y_avg, z_avg, vx, vy, vz, "text_curve.csv")
